...
<!-- panel:comparison -->
**صورة الملف الشخصي مقابل الوصف**
- **صورة الملف الشخصي:** يجب أن تكون صورة (JPG/PNG). تُعرض بوضوح في أعلى المحادثة.
- **الوصف (Description):** نص يصف نشاطك التجاري. بحد أقصى 256 حرف. يُعرض في واجهة معلومات جهة الاتصال.
<!-- endpanel -->
\n
<!-- panel:quiz -->
أي من الحقول التالية لا يمكن تحديثه (تغييره) عبر WhatsApp Business Profile API مباشرة؟
- [ ] العنوان (address)
