...
<!-- panel:comparison -->
**Flows v3 مقابل Flows v4**
- **الإصدار الثالث (Flows v3):** نماذج أساسية وتصميمات ثابتة. كان توجيه الشاشات يتطلب منطقاً معقداً من السيرفر.
- **الإصدار الرابع (Flows v4):** يقدم التوجيه المشروط (Branching)، والتحقق من جانب العميل، وتحديث الواجهة دون الاتصال بالسيرفر.
<!-- endpanel -->
\n
<!-- panel:quiz -->
ما هي الميزة الرئيسية التي تم تقديمها في WhatsApp Flows v4؟
