---
title: * Clarified the Business phone numbers documentation: deleting a business phone number isn
date: 2026-06-03
...
summary_short: * Clarified the Business phone numbers documentation: deleting a business phone number isn’t supported via the API. Use WhatsApp Manager⁠ to
audit_corrections: backfill (historical entry, not diff-detected)
---

## Summary

* Clarified the Business phone numbers documentation: deleting a business phone number isn’t supported via the API. Use WhatsApp Manager⁠ to delete a business phone number.
